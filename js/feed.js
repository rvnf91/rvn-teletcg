$(document).ready(function() {
    ...
    // SEARCH API KEY & URL
    var searchAPI = "b9f91d369ff59547cd47b931d8cbc56b:0:74623931";
    var searchURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=" + searchAPI + "&q=";

    // MOST POPULAR ARTICLES API KEY & URL
    var popularAPI = "506eb7d882cd425596bf1e7edf957db2";
    ...
    var topStoriesAPI = "26f44f61431147eeafeb8ae27648616c";
	...
	$(function() {
        $('#cp4').colorpicker().on('changeColor', function(e) {
            $('.sidebar, .navbar').css('background-color', e.color.toString('rgba'));
        });
    });
});